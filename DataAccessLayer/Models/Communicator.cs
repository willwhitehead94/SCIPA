...
namespace DataAccessLayer.Models
{
    public class Communicator
    {
        ...
        public Communicator(int id, int deviceId, int communicatorTypeId, int subId, int valueTypeId)
        {
            _id = id;
        ...
        public Communicator(string id, string deviceId, string communicatorTypeId, string subId, string valueTypeId)
        {
