...
namespace DataAccessLayer.Models
{
    public class CommandVM
    {
        ...
        public CommandVM (int id, int deviceId, int commandTypeId, int communicatorId, string commandText, int returnValueTypeId, bool enabled)
        {
            _id = id;
            _deviceId = deviceId;
        ...
        public CommandVM(string id, string deviceId, string commandTypeId, string communicatorId, string commandText, string returnValueTypeId, string enabled)
        {
