...
namespace DomainLogicLayer.ViewModels
{
    public class LocationVM
    {
        ...
        public LocationVM (int id, string name, double? longitude, double? latitude, string notes)
        {
            _id = id;
            Name = name;
            Longitude = longitude;
        ...
        public LocationVM (string id, string name, string longitude, string latitude, string notes)
        {
